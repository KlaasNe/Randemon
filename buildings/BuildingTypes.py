...
class BuildingTypes(Enum):
    ...
    GYM = BuildingType("gym", (19, 23), (6, 5), (3, 5))
    POWERPLANT = BuildingType("powerplant", (16, 34), (11, 7), (6, 8))
    H0 = BuildingType("h0", (4, 0), (5, 4), (1, 3))
    H1 = BuildingType("h1", (9, 0), (5, 4), (1, 3))
    H2 = BuildingType("h2", (0, 4), (4, 5), (1, 3))
    ...
    H8 = BuildingType("h8", (0, 13), (4, 5), (1, 3))
    H9 = BuildingType("h9", (4, 13), (5, 4), (1, 3))
    H10 = BuildingType("h10", (9, 13), (5, 3), (1, 3))
    H11 = BuildingType("h11", (0, 18), (4, 5), (1, 3))
    H12 = BuildingType("h12", (4, 17), (5, 4), (1, 3))
    H13 = BuildingType("h13", (9, 16), (5, 5), (1, 3))
    H14 = BuildingType("h14", (0, 23), (4, 7), (1, 3))
    H15 = BuildingType("h15", (14, 10), (5, 5), (3, 3))
    H16 = BuildingType("h16", (14, 15), (5, 5), (3, 3))
    H17 = BuildingType("h17", (14, 25), (5, 5), (3, 3))
    H18 = BuildingType("h18", (13, 30), (6, 4), (3, 3))
    H19 = BuildingType("h19", (19, 0), (7, 5), (1, 3))
    H20 = BuildingType("h20", (19, 12), (7, 6), (1, 3))
